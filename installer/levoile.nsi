...
Section "Install"
  ...
  ; of parent ACL, so this NSIS install does NOT need to change %ProgramData%
  ; ACLs. Defense in depth: future hardening could pre-create the directory
  ; with restrictive ACL via the AccessControl plugin.
  File /nonfatal "build\${CTL_EXE}"
